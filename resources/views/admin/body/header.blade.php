        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('admin_profile') }}"><i class="ri-user-line align-middle me-1"></i> Profile</a>
                    <a class="dropdown-item" href="{{ route('password_change') }}"><i class="ri-wallet-2-line align-middle me-1"></i> Password Change</a>
