        ...
        <div class="col-12">
            <div class="card mt-0">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('save_multi_image') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- end row -->
                        <input type="submit" class="form-control btn btn-info waves-effect waves-light" value="Save Multiple Image">
                    </form>
