                    ...
                    <div class="breadcrumb__wrap__content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('front_about') }}">About Me</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about__image">
                        <img src="{{ asset($frontAbout->about_image) }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about__content">
                        <div class="section__title">
                            ...
                            <h2 class="title">{{ $frontAbout->title }}</h2>
                        </div>
                        <div class="about__exp">
                            ...
                            <div class="about__exp__content">
                                <p><span>{{ $frontAbout->short_title }}</span> </p>
                            </div>
                        </div>
                        <p class="desc">{{ $frontAbout->short_description }}</p>
                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                                <p class="desc">{!! $frontAbout->long_description !!}</p>
