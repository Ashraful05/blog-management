                            ...
                            <div class="portfolio__active">
                                ...
                                <div class="portfolio__item">
                                    ...
                                    <div class="portfolio__overlay__content">
                                        ...
                                        <h4 class="title"><a href="{{ route('portfolio_details',$portfolio->id) }}">{{ $portfolio->portfolio_title }}</a></h4>
                                        <a href="{{ route('portfolio_details',$portfolio->id) }}" class="link">Case Study</a>
                                    </div>
                                </div>
                                @endforeach
                            </div>
