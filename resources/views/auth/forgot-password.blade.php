...
<head>
    ...
    <meta charset="utf-8" />
    <title>Recover Password | Upcube - Admin</title>
                ...
                <div class="p-3">
                    <form class="form-horizontal mt-3" action="{{ route('password.email') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            <div class="col-xs-12">
                                <input class="form-control" id="email" value="{{ old('email') }}" name="email" type="email" required="" placeholder="Email">
                            </div>
                        </div>
                    ...
                    <div class="form-group pb-2 text-center row mt-3">
                        <div class="col-12">
                            <a href="{{ route('login') }}"><button class="btn btn-info w-100 waves-effect waves-light" type="submit">Back to login</button></a>
